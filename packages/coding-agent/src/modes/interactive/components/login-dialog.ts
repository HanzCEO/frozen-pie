import type { AuthInfoLink } from "@earendil-works/pi-ai";
...
/**
 * Login dialog component - replaces editor during the API-key login flow.
 * Collects a secret API key (or provider-env selections) via prompt steps.
 */
